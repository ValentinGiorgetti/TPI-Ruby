...
User.create( [ {name: 'Oscar', surname: 'Castilla', email: 'admin@gmail.com', password: '123456', role: "admin"},
...
Appointment.create( [ {professional_id: 1, name: 'Carlos', surname: 'Perez', phone: '12345214', date_time: DateTime.strptime("11/1/2022 13:00", "%d/%m/%Y %H:%M")},
                      {professional_id: 1, name: 'Alberto', surname: 'Martinez', phone: '12345213', date_time: DateTime.strptime("11/1/2022 15:00", "%d/%m/%Y %H:%M")},
